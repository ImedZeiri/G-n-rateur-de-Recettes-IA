...
const translations = {
  en: {
    ...
    cuisineLabel: 'Type of Cuisine',
    cuisineAny: 'Surprise Me!',
  ...
  es: {
    ...
    cuisineLabel: 'Tipo de Cocina',
    cuisineAny: '¡Sorpréndeme!',
  ...
  ar: {
    ...
    cuisineAny: 'فاجئني!',
    cuisineItalian: 'إيطالي',
    cuisineFrench: 'فرنسي',
    cuisineMexican: 'مكسيكي',
    cuisineChinese: 'صيني',
    cuisineIndian: 'هندي',
    cuisineJapanese: 'ياباني',
    cuisineMediterranean: 'بحر أبيض متوسط',
  }
};
